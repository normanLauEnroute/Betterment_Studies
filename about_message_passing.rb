...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Thanks stackoverflow.com: Some classes (for example the standard library's socket class)
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # Ans: if the redefined :method_missing method did not raise NoMethodError
    # then no exception would be raised. A call to super is necessary...
    #
    # NOTE:
    #
