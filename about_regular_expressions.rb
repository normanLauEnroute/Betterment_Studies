...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # Because they slurp up all the characters they match until a non-matching character
  ...
  # Character classes compare single characters while alternations can compare several characters at a time
